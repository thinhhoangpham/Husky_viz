...
PYTHONPATH=~/Documents/Husky_viz/.worktrees/constellation-matcher:$PYTHONPATH python3 ~/Documents/Husky_viz/.worktrees/constellation-matcher/landmark_loc/localizer_node.py
```
